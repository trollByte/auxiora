 ...
 */
export const EMOTIONAL_OVERRIDES: Record<EmotionalRegister, Partial<Record<keyof TraitMix, number>>> = {
 ...
 * and capped at 1.0.
 */
export function applyEmotionalOverride(baseMix: TraitMix, emotion: EmotionalRegister): TraitMix {
